    ...
    <View style={styles.boxContainer}>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('InformationDrinksLimon')}>
          <Image
            style={styles.image}
            source={require('../../asset/Drinks/caipirinha-cadareceita.jpg')}
          />
        </TouchableOpacity>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('InformationDrinksMarg')}>
          <Image
            style={styles.image}
            source={require('../../asset/Drinks/jasmine.jpg')}
          />
        </TouchableOpacity>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('InformationGinTonica')}>
          <Image
            style={styles.image}
            source={require('../../asset/Drinks/gin.png')}
          />
          </TouchableOpacity>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('InformationLimao')}>
        <Image
          style={styles.image}
          source={require('../../asset/Drinks/condensado.jpg')}
        />
        </TouchableOpacity>
        <Text style={styles.texto}>Caipirinha de limão</Text>
        </View>
