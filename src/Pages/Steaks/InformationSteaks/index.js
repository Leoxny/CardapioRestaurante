 ...
 return (
   <View style={styles.container}>
        <View>
            <Image
            style={styles.image}
            source={require('../../../asset/Steaks/mignon.jpg')}
            />
            <Text style={styles.about}>Gravy Mignon</Text>
        </View>
        <View style={styles.colum}>
            <Text style={styles.title}>Descrição</Text>
            <Text style={styles.desc}>Medalhão de mignon com bacon crocante e o clássico molho madeira cremoso a base de vinho do porto e cogumelos.
            </Text>
        </View>
